...
const styles = StyleSheet.create({
  ...
  avatar:      { width: 96, height: 96, borderRadius: 48, backgroundColor: '#EEF2FF', alignItems: 'center', justifyContent: 'center', marginBottom: 14 },
  ...
  badge:       { backgroundColor: '#EEF2FF', borderRadius: 20, paddingHorizontal: 14, paddingVertical: 6, marginTop: 10 },
  badgeText:   { fontFamily: 'Inter_600SemiBold', fontSize: 12, color: '#6366F1' },
